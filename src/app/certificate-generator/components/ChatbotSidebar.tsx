...
export default function ChatbotSidebar({ onImageGenerated }) {
  ...
  const suggestions = useMemo(
    () => [
      ...
      "University logo and official seal",
      "Elegant parchment background texture",
      "Professional signature lines",
      "Formal certificate typography",
      "Academic achievement design",
    ],
    [],
  )
  ...
  const sendMessage = useCallback(async () => {
    ...
    try {
      ...
      const errorMsg = {
        role: "bot",
        text: `❌ ${errorMessage}. Try describing specific certificate elements like:\n• "Elegant gold border with decorative patterns"\n• "University seal and official logo"\n• "Professional signature areas"\n• "Formal certificate background"`,
      }
